...
public class PackingListDAO {
    ...
    /**
     * Insert a new packing list (using a PackingList object) and return generated ID
     */
    public int createPackingList(PackingList list) {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("createPackingList(PackingList) failed: " + e.getMessage());
            e.printStackTrace();
        }
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    // use column names that exist in your schema
            ...
            System.err.println("getPackingListsByUser failed: " + e.getMessage());
            e.printStackTrace();
        }
        return lists;
    }
    ...
    public PackingList getPackingListById(int listId) {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("getPackingListById failed: " + e.getMessage());
            e.printStackTrace();
        }
        return null;
    }
    ...
    public boolean deletePackingList(int listId) {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("deletePackingList failed: " + e.getMessage());
            e.printStackTrace();
        }
        return false;
    }
    ...
    public boolean addItemToList(Item item) {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("addItemToList failed: " + e.getMessage());
            e.printStackTrace();
        }
        return false;
    }
    ...
    public List<Item> getItemsByListId(int listId) {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("getItemsByListId failed: " + e.getMessage());
            e.printStackTrace();
        }
        return items;
    }
    ...
    public void setItemPackedStatus(int itemId, boolean isPacked) {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("setItemPackedStatus failed: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public int getTotalItemsCount(int listId) {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("getTotalItemsCount failed: " + e.getMessage());
            e.printStackTrace();
        }
        return 0;
    }
    ...
    /**
     * initSchema - keep present (your project used this), creates a simple packing_list table if not exists.
     * Note: this method is safe to call; it obtains its own connection and closes it.
     */
    public void initSchema() {
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("initSchema failed: " + e.getMessage());
            e.printStackTrace();
        }
    }

    /**
     * createPackingList (alternate overload used by some UI code) - keep overload
     */
    public int createPackingList(String name, String destination, String dates, String type) {
        String sql = "INSERT INTO packing_list (name, destination, dates, type) VALUES (?, ?, ?, ?)";
        try (Connection conn = DatabaseConfig.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            System.err.println("createPackingList(String...) failed: " + e.getMessage());
            e.printStackTrace();
        }
        return -1;
    }
    ...
    public int getPackedItemsCount(int listId) {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("getPackedItemsCount failed: " + e.getMessage());
            e.printStackTrace();
        }
        return 0;
    }
